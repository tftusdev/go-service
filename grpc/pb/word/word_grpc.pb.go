...
type WordClient interface {
	GetTop10MostUsedWords(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *wordClient) GetTop10MostUsedWords(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/word.Word/GetTop10MostUsedWords", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WordServer interface {
	GetTop10MostUsedWords(context.Context, *Request) (*Response, error)
...
func (UnimplementedWordServer) GetTop10MostUsedWords(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTop10MostUsedWords not implemented")
}
...
func _Word_GetTop10MostUsedWords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WordServer).GetTop10MostUsedWords(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/word.Word/GetTop10MostUsedWords",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WordServer).GetTop10MostUsedWords(ctx, req.(*Request))
	}
...
var Word_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetTop10MostUsedWords",
			Handler:    _Word_GetTop10MostUsedWords_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "grpc/proto/word.proto",
}
